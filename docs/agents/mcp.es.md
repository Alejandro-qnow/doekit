...
El servidor MCP es la contraparte del [skill diseñador de experimentos](index.md):
...
[chuleta de API](reference.md) para toda la superficie de la librería que un agente

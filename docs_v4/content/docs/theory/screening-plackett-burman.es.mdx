...
description: "Con muchos factores candidatos y un presupuesto ajustado, la primera pregunta no es"
---
...
[folding](fractional-factorial) y el [definitive screening](definitive-screening).
...
- Teoría: [Factorial fraccional](fractional-factorial),

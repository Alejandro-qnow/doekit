---
title: "Agentic layer (interpret · decide · monitor · memory)"
description: "doekit is built for a hybrid audience — people and LLM agents — on one engine."
---
...
The whole loop is exposed to agents by the [MCP server](../agents/mcp):

---
title: "Factors and coding"
description: "An experimenter thinks in natural units (°C, mol/L, a catalyst brand). The"
---
...
- Theory: [Mixture and split-plot](mixture-and-split-plot)

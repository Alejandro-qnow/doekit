---
title: "Diseños de superficie de respuesta"
description: "Cuando el screening ya encontró los pocos factores que importan, el objetivo cambia de"
---
...
- Teoría: [Definitive screening](definitive-screening),
  [Métricas de evaluación](evaluation-metrics)
- API: [`box_behnken`, `central_composite`](../api/designs)

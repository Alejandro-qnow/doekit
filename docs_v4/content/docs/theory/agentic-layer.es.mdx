---
title: "Capa agéntica (interpret · decide · monitor · memory)"
description: "doekit está hecho para un público híbrido — personas y agentes LLM — sobre un"
---
...
Todo el loop se expone a agentes por el [servidor MCP](../agents/mcp):

---
title: "Diseño óptimo"
description: "Las plantillas estándar (factorial, Box-Behnken, CCD) asumen una región cúbica/esférica"
---
...
- Teoría: [Métricas de evaluación](evaluation-metrics)
- API: [`optimal_design`, `kl_exchange`, `fedorov_exchange`, criterios](../api/designs)

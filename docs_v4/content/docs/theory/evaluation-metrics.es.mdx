...
description: "Este es el diferenciador de doekit. Construir un diseño es fácil; saber si de verdad"
---
...
hay respuestas, el [loop de optimización](bayesian-optimization) ajusta un
...
- Teoría: [Reporte](reporting), [Diseño óptimo](optimal-design),

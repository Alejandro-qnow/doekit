---
title: "Diseños factoriales fraccionales"
description: "Un factorial completo en $k$ factores de dos niveles cuesta $2^k$ corridas — 1024 para"
---
...
- Teoría: [Screening (Plackett-Burman)](screening-plackett-burman)

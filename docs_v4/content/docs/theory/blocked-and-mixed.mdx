---
title: "Blocked and mixed analysis"
description: "From doekit 0.4, analysis is no longer limited to plain OLS. Blocking,"
---
...
[Mixture and split-plot](mixture-and-split-plot) (`split_plot_design`,
`hard_to_change=`).

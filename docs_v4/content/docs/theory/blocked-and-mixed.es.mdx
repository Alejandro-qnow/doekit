---
title: "Análisis con bloques y modelos mixtos"
description: "Desde doekit 0.4, el análisis ya no se limita a OLS simple. Bloques fijos,"
---
...
[Mezcla y split-plot](mixture-and-split-plot) (`split_plot_design`,
`hard_to_change=`).

---
title: "Sequential / adaptive DoE"
description: "Classical DoE is often taught as a one-shot plan. In practice you run a"
---
...
**[Bayesian optimization](bayesian-optimization)** (the `intent="optimize"`
...
Related shipping surface (doekit ≥ 0.6 / 0.7): [mixture & split-plot](mixture-and-split-plot),
and the aggregate `ed.experiment(...)` / `Experiment` loop in the
[agents cheat sheet](../agents/reference).

---
title: "Overview"
description: "doekit is hybrid: the same engine serves people and LLM agents. Agents"
---
...
- **[MCP server](mcp)** — the same loop as callable tools (recommend / evaluate
...
| File | Role |
|------|------|
| [SKILL.md](SKILL) | Workflow, gates, reply template. Keep filename `SKILL.md`. |
| [reference.md](reference) | Self-contained API cheat sheet |

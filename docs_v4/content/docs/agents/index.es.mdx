---
title: "Resumen"
description: "Skill portable de diseñador de experimentos doekit: enseña a un agente el"
---
...
| Archivo | Rol |
|---------|-----|
| [SKILL.md](SKILL) | Flujo, gates, plantilla de respuesta. Conserva el nombre `SKILL.md`. |
| [reference.md](reference) | Cheat sheet de API autocontenido |

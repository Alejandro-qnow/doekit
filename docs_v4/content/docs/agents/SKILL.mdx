...
description: "Agent Skill for Design-of-Experiments with doekit: brief → recommend → evaluate → analyze."
---

This page is the portable Agent Skill package (`SKILL.md`).
...
Escape hatches (see [reference.md](reference)): user already chose a generator
...
- API detail: [reference.md](reference).
